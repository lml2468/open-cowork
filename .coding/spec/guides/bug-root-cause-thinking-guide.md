...
**Example**: Native-module ABI mismatch

```
// better-sqlite3 compiled for Electron's ABI, then loaded under Node (tests):
Error: The module was compiled against a different Node.js version
```

Discovered only at runtime; the fix is a rebuild step (`scripts/ensure-sqlite.js`),
not better typing. See `../shared/npm-electron-setup.md` and
`../shared/testing.md`.
...
| Database/schema issue | `db-schema-change-guide.md`     |
