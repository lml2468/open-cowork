#!/usr/bin/env python3
"""
Standalone reader for .coding/config.yaml.
...
CONFIG_REL_PATH = ".coding/config.yaml"
...
def read_coding_config(repo_root: Optional[Path] = None) -> dict:
    """Read .coding/config.yaml. Returns {} on missing or malformed file."""
