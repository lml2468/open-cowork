#!/usr/bin/env python3
"""
Common path utilities for Coding workflow.
...
def get_repo_root(start_path: Path | None = None) -> Path:
    """Find the nearest directory containing .coding/ folder.
    ...
    Returns:
        Path to repository root, or current directory if no .coding/ found.
    """
    ...
    # Fallback to current directory if no .coding/ found
...
def normalize_task_ref(task_ref: str) -> str:
    ...
    `.coding/tasks/03-27-my-task`, even on Windows. Absolute paths are preserved
...
def get_spec_dir(package: str | None = None, repo_root: Path | None = None) -> Path:
    ...
    Single-repo: .coding/spec
    Monorepo with package: .coding/spec/<package>
