...
2. `.coding/scripts/get_context.py`
3. `.coding/scripts/common/session_context.py`
4. `.coding/scripts/common/task_context.py`
5. `.coding/scripts/common/active_task.py`
...
| Source                                 | Purpose                                      |
| -------------------------------------- | -------------------------------------------- |
| `.coding/workflow.md`                  | Workflow and next-action hints.              |
| `.coding/tasks/<task>/prd.md`          | Current task requirements.                   |
| `.coding/tasks/<task>/design.md`       | Complex task technical design.               |
| `.coding/tasks/<task>/implement.md`    | Complex task execution plan.                 |
| `.coding/tasks/<task>/implement.jsonl` | Spec/research to read before implementation. |
| `.coding/tasks/<task>/check.jsonl`     | Spec/research to read during checking.       |
| `.coding/spec/`                        | Project specs.                               |
| `.coding/workspace/`                   | Session records.                             |
...
| Change hints on each user input              | `[workflow-state:STATUS]` block in `.coding/workflow.md`. The `inject-workflow-state` hook is parser-only and reads the block verbatim. |
...
```jsonl
{"file": ".coding/spec/backend/index.md", "reason": "Backend conventions"}
{"file": ".coding/tasks/04-28-x/research/api.md", "reason": "API research"}
```
...
- `.coding/scripts/common/session_context.py`
...
- agent pull: edit the read steps in the corresponding `coding-implement` / `coding-check` agent file.
...
python3 ./.coding/scripts/task.py list-context <task>
