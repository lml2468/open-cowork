...
Use this skill only after task-creation consent has been given and the user is ready to enter Coding planning.

If no task exists yet, create one:

```bash
TASK_DIR=$(python3 ./.coding/scripts/task.py create "<short task title>" --slug <slug>)
```
...
2. Inspect available evidence before asking questions:
   ...
   - related Coding tasks, research files, and session history when present
