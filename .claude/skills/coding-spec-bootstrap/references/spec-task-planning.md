...
Use a single agent as the default execution model. The agent may create Coding tasks for traceability, but the skill should not require a specific platform, CLI, or parallel worker model.
...
When a Coding task is useful, write a concise PRD with these sections:

```markdown
# Fill <package-or-layer> Coding Specs

## Goal

Write project-specific `.coding/spec/` guidance for <scope>.
...
- `.coding/spec/.../index.md`
- `.coding/spec/.../<topic>.md`
