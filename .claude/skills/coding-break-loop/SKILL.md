...
- [ ] Update `.coding/spec/guides/` thinking guides
- [ ] Update relevant `.coding/spec/` docs
...
2. **Sync templates** - After updating `.coding/spec/`, sync to `src/templates/markdown/spec/`
