            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex min-w-[92px] flex-shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-lg bg-accent px-3 py-2 text-sm text-on-accent disabled:opacity-50"
                >
