  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-body-sm text-text-secondary">{t('remote.connectionDesc')}</p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 text-caption rounded-full bg-success/10 text-success font-medium">
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-body-sm text-text-secondary mt-1">{t('remote.webhookDesc')}</p>
          </div>
          <div
            className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
        ...
        {!useLongConnection && (
          <div className="mt-4 pt-4 border-t border-border/50 space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <code className="flex-1 px-3 py-2 bg-surface-hover rounded-lg text-body-sm font-mono text-text-secondary truncate">
            ...
            <div className="p-4 rounded-lg bg-surface-hover">
              ...
              {tunnelEnabled && (
                <div>
                  <input
                    ...
                    className="w-full px-3 py-2 bg-surface border border-border rounded-lg text-body-sm text-text-primary focus:border-accent focus:outline-none"
              ...
              {tunnelStatus?.connected && webhookUrl && (
                <div className="mt-3 p-2 rounded-lg bg-success/10">
                  ...
                  <code className="block mt-1 text-caption font-mono text-text-secondary truncate">
                    {webhookUrl}
                  </code>
                </div>
              )}
      ...
      {useLongConnection && (
        <div className="p-4 rounded-xl bg-accent-muted border border-accent/20">
          <p className="text-body-sm text-accent">{t('remote.longConnectionHint')}</p>
        </div>
      )}
    </div>
  );
